...
class AnalyticalAxisService {
  async getAll(params?: any) { try { const r = await apiService.get(`${BASE_PATH}/analytics/axes/`, { params }); return r.data; } catch { return { results: [], count: 0 }; } }
  async getById(id: string) { try { const r = await apiService.get(`${BASE_PATH}/analytics/axes/${id}/`); return r.data; } catch { return null; } }
  async create(data: any) { const r = await apiService.post(`${BASE_PATH}/analytics/axes/`, data); return r.data; }
  async update(id: string, data: any) { const r = await apiService.patch(`${BASE_PATH}/analytics/axes/${id}/`, data); return r.data; }
  async delete(id: string) { await apiService.delete(`${BASE_PATH}/analytics/axes/${id}/`); }
}

class AnalyticalCentersService {
  async getAll(params?: any) { try { const r = await apiService.get(`${BASE_PATH}/analytics/centers/`, { params }); return r.data; } catch { return { results: [], count: 0 }; } }
  ...
  async create(data: any) { const r = await apiService.post(`${BASE_PATH}/analytics/centers/`, data); return r.data; }
  async update(id: string, data: any) { const r = await apiService.patch(`${BASE_PATH}/analytics/centers/${id}/`, data); return r.data; }
  async delete(id: string) { await apiService.delete(`${BASE_PATH}/analytics/centers/${id}/`); }
}

class BudgetsService {
  async getAll(params?: any) { try { const r = await apiService.get(`${BASE_PATH}/budgeting/budgets/`, { params }); return r.data; } catch { return { results: [], count: 0 }; } }
  async getById(id: string) { try { const r = await apiService.get(`${BASE_PATH}/budgeting/budgets/${id}/`); return r.data; } catch { return null; } }
  async create(data: any) { const r = await apiService.post(`${BASE_PATH}/budgeting/budgets/`, data); return r.data; }
  async update(id: string, data: any) { const r = await apiService.patch(`${BASE_PATH}/budgeting/budgets/${id}/`, data); return r.data; }
  async delete(id: string) { await apiService.delete(`${BASE_PATH}/budgeting/budgets/${id}/`); }
}

class BudgetControlService {
  async getAll(params?: any) { try { const r = await apiService.get(`${BASE_PATH}/budgeting/controls/`, { params }); return r.data; } catch { return { results: [], count: 0 }; } }
  ...
  async getSummary(params?: any) { try { const r = await apiService.get(`${BASE_PATH}/budgeting/controls/summary/`, { params }); return r.data; } catch { return { total_budget: 0, total_actual: 0, variance: 0 }; } }
}

class TaxDeclarationsService {
  async getAll(params?: any) { try { const r = await apiService.get(`${BASE_PATH}/taxation/declarations/`, { params }); return r.data; } catch { return { results: [], count: 0 }; } }
  ...
  async create(data: any) { const r = await apiService.post(`${BASE_PATH}/taxation/declarations/`, data); return r.data; }
  async update(id: string, data: any) { const r = await apiService.patch(`${BASE_PATH}/taxation/declarations/${id}/`, data); return r.data; }
