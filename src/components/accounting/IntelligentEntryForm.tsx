          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div className="relative">
              ...
              <div className="relative">
                ...
                />
                <Search className="absolute right-3 top-1/2 transform -tranprimary-y-1/2 w-4 h-4 text-gray-700" />
              </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  step="0.01"
                />
                <span className="absolute right-3 top-1/2 transform -tranprimary-y-1/2 text-gray-700">€</span>
              </div>
            </div>
