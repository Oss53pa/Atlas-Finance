 ...
 * Avatar de l'assistante virtuelle Pamela - Jeune fille africaine
 */

import React from 'react';

interface PamelaAvatarProps {
  size?: 'sm' | 'md' | 'lg' | 'xl';
  isTyping?: boolean;
  className?: string;
  showName?: boolean;
...
export const PamelaAvatar: React.FC<PamelaAvatarProps> = ({
  size = 'md',
  isTyping = false,
  className = '',
  showName = false,
  ...
  return (
    <div className={`pamela-avatar pamela-avatar--${size} ${isTyping ? 'pamela-avatar--typing' : ''} ${className}`}>
      <div className="pamela-avatar__container" style={{ width: avatarSize, height: avatarSize }}>
        <svg
          width={avatarSize}
          height={avatarSize}
          viewBox="0 0 80 80"
        ...
        >
          ...
          <rect x="20" y="20" width="40" height="4" fill="#FF1493" rx="2"/>
          ...
          {isTyping ? (
            ...
            <>
              ...
              <path d="M 32 48 Q 40 52 48 48" fill="#FF69B4" opacity="0.3"/>
            </>
          )}

          {/* Joues rosées */}
          <ellipse cx="25" cy="44" rx="4" ry="3" fill="#FF69B4" opacity="0.3"/>
          <ellipse cx="55" cy="44" rx="4" ry="3" fill="#FF69B4" opacity="0.3"/>

          {/* Cou et épaules */}
          <rect x="35" y="55" width="10" height="10" fill="#8B4513" rx="2"/>
          <path d="M 25 65 Q 40 70 55 65 L 55 80 L 25 80 Z" fill="#FF69B4" opacity="0.8"/>
        ...
        {isTyping && (
          <div className="pamela-typing-indicator">
            <span></span>
            <span></span>
            <span></span>
          </div>
