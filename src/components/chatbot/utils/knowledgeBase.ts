/**
 * Knowledge Base for Atlas Studio Assistant
...
export const knowledgeBase: KnowledgeBaseEntry[] = [
  // DASHBOARD
  {
    ...
    content: 'Le tableau de bord Atlas Studio vous donne un aperçu en temps réel de votre activité financière. Vous y trouverez les métriques clés, les graphiques de performance, les notifications importantes et les raccourcis vers les modules principaux.',
    category: 'dashboard',
