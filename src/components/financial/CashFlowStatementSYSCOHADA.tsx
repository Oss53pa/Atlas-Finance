        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <div className="mt-2 space-y-1">
              <p className="text-lg font-semibold text-[#171717]/90">{cashFlowData.company.name}</p>
              <p className="text-sm text-[#171717]/70">{cashFlowData.company.address}</p>
          ...
          <div className="flex items-center space-x-4">
            <div className="flex items-center space-x-2">
              ...
              <span className={`text-sm font-medium ${
                cashFlowData.isCashFlowBalanced ? 'text-[#171717]' : 'text-[#525252]'
              }`}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="bg-[#f5f5f5] p-6 rounded-lg shadow-sm border border-[#e5e5e5]">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-[#171717]/70">Flux d'Exploitation</p>
              <p className={`text-lg font-bold ${getFlowColor(cashFlowData.operatingCashFlow)}`}>
                {formatCurrency(cashFlowData.operatingCashFlow)}
              </p>
              <p className="text-sm text-[#171717]">CAF: {formatCurrency(cashFlowData.selfFinancingCapacity)}</p>
            </div>
            <div className="h-12 w-12 bg-[#171717]/20 rounded-lg flex items-center justify-center">
        ...
        <div className="bg-[#f5f5f5] p-6 rounded-lg shadow-sm border border-[#e5e5e5]">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-[#171717]/70">Flux d'Investissement</p>
              <p className={`text-lg font-bold ${getFlowColor(cashFlowData.investmentCashFlow)}`}>
                {formatCurrency(cashFlowData.investmentCashFlow)}
              </p>
              <p className="text-sm text-[#171717]">Acquisitions nettes</p>
            </div>
            <div className="h-12 w-12 bg-[#171717]/15 rounded-lg flex items-center justify-center">
        ...
        <div className="bg-[#f5f5f5] p-6 rounded-lg shadow-sm border border-[#e5e5e5]">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-[#171717]/70">Flux de Financement</p>
              <p className={`text-lg font-bold ${getFlowColor(cashFlowData.financingCashFlow)}`}>
                {formatCurrency(cashFlowData.financingCashFlow)}
              </p>
              <p className="text-sm text-[#525252]">Emprunts nets</p>
            </div>
            <div className="h-12 w-12 bg-[#525252]/15 rounded-lg flex items-center justify-center">
        ...
        <div className="bg-[#f5f5f5] p-6 rounded-lg shadow-sm border border-[#e5e5e5]">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-[#171717]/70">Variation Trésorerie</p>
              <p className={`text-lg font-bold ${getFlowColor(cashFlowData.cashFlowVariation)}`}>
                {formatCurrency(cashFlowData.cashFlowVariation)}
              </p>
              <p className="text-sm text-[#525252]">Total période</p>
            </div>
            <div className="h-12 w-12 bg-[#525252]/20 rounded-lg flex items-center justify-center">
          ...
          <table className="min-w-full">
            ...
            <tbody className="divide-y divide-[#e5e5e5]">
              ...
              <tr className="bg-[#171717]/10">
                <td colSpan={2} className="px-6 py-3 font-bold text-[#171717] text-lg">
              ...
              <tr>
                ...
                <td className="px-6 py-2 text-sm text-[#171717]/50"></td>
                <td className="px-6 py-2 text-right text-sm font-medium">{formatCurrency(cashFlowData.netResultForCashFlow)}</td>
              </tr>
              
              <tr>
                <td className="px-6 py-2 pl-8 text-sm text-[#171717]/70">+ Dotations aux amortissements et provisions</td>
                <td className="px-6 py-2 text-sm text-[#171717]/50"></td>
                <td className="px-6 py-2 text-right text-sm text-[#171717]">+{formatCurrency(cashFlowData.depreciationAndProvisions)}</td>
              </tr>
              
              <tr>
                <td className="px-6 py-2 pl-8 text-sm text-[#171717]/70">- Reprises de provisions</td>
                <td className="px-6 py-2 text-sm text-[#171717]/50"></td>
                <td className="px-6 py-2 text-right text-sm text-[#525252]">-{formatCurrency(cashFlowData.provisionsReversals)}</td>
              </tr>
              
              <tr>
                <td className="px-6 py-2 pl-8 text-sm text-[#171717]/70">± Plus et moins-values de cession</td>
                <td className="px-6 py-2 text-sm text-[#171717]/50"></td>
                <td className="px-6 py-2 text-right text-sm">{formatCurrency(cashFlowData.valueAdjustments)}</td>
              </tr>
              
              <tr className="bg-[#171717]/20">
                <td className="px-6 py-3 pl-8 text-sm font-semibold text-[#171717]">= Capacité d'autofinancement (CAF)</td>
                <td className="px-6 py-3 text-sm text-[#171717]/50"></td>
                <td className="px-6 py-3 text-right text-sm font-bold text-[#171717]">
                  {formatCurrency(cashFlowData.selfFinancingCapacity)}
                </td>
              </tr>
              
              <tr>
                <td className="px-6 py-2 pl-8 text-sm text-[#171717]/70">- Variation du besoin en fonds de roulement</td>
                <td className="px-6 py-2 text-sm text-[#171717]/50"></td>
                <td className="px-6 py-2 text-right text-sm text-[#525252]">-{formatCurrency(Math.abs(cashFlowData.workingCapitalVariation))}</td>
              </tr>
              
              <tr className="bg-[#171717]/30 font-bold">
                <td className="px-6 py-4 font-bold text-[#171717]">
                  = FLUX NET DE TRÉSORERIE GÉNÉRÉ PAR L'ACTIVITÉ
                </td>
                <td className="px-6 py-4"></td>
                <td className="px-6 py-4 text-right font-bold text-[#171717] text-lg">
                  {formatCurrency(cashFlowData.operatingCashFlow)}
                </td>
              </tr>
              ...
              <tr>
                <td className="px-6 py-2 pl-8 text-sm text-[#171717]/70">- Acquisitions d'immobilisations corporelles et incorporelles</td>
                <td className="px-6 py-2 text-sm text-[#171717]/50"></td>
                <td className="px-6 py-2 text-right text-sm text-[#525252]">-{formatCurrency(cashFlowData.fixedAssetsAcquisitions)}</td>
              </tr>
              
              <tr>
                <td className="px-6 py-2 pl-8 text-sm text-[#171717]/70">+ Cessions d'immobilisations corporelles et incorporelles</td>
                <td className="px-6 py-2 text-sm text-[#171717]/50"></td>
                <td className="px-6 py-2 text-right text-sm text-[#171717]">+{formatCurrency(cashFlowData.fixedAssetsDisposals)}</td>
              </tr>
              
              <tr>
                <td className="px-6 py-2 pl-8 text-sm text-[#171717]/70">- Acquisitions d'immobilisations financières</td>
                <td className="px-6 py-2 text-sm text-[#171717]/50"></td>
                <td className="px-6 py-2 text-right text-sm text-[#525252]">-{formatCurrency(cashFlowData.financialAssetsAcquisitions)}</td>
              </tr>
              
              <tr>
                <td className="px-6 py-2 pl-8 text-sm text-[#171717]/70">+ Cessions d'immobilisations financières</td>
                <td className="px-6 py-2 text-sm text-[#171717]/50"></td>
                <td className="px-6 py-2 text-right text-sm text-[#171717]">+{formatCurrency(cashFlowData.financialAssetsDisposals)}</td>
              </tr>
              ...
              <tr className="bg-[#525252]/10">
                <td colSpan={2} className="px-6 py-3 font-bold text-[#525252] text-lg">
              ...
              <tr>
                <td className="px-6 py-2 pl-8 text-sm text-[#171717]/70">+ Augmentation de capital en numéraire</td>
                <td className="px-6 py-2 text-sm text-[#171717]/50"></td>
                <td className="px-6 py-2 text-right text-sm">{formatCurrency(cashFlowData.capitalIncrease)}</td>
              </tr>
              
              <tr>
                <td className="px-6 py-2 pl-8 text-sm text-[#171717]/70">+ Subventions d'investissement reçues</td>
                <td className="px-6 py-2 text-sm text-[#171717]/50"></td>
                <td className="px-6 py-2 text-right text-sm text-[#171717]">+{formatCurrency(cashFlowData.investmentSubsidiesReceived)}</td>
              </tr>
              
              <tr>
                <td className="px-6 py-2 pl-8 text-sm text-[#171717]/70">+ Nouveaux emprunts</td>
                <td className="px-6 py-2 text-sm text-[#171717]/50"></td>
                <td className="px-6 py-2 text-right text-sm text-[#171717]">+{formatCurrency(cashFlowData.newBorrowings)}</td>
              </tr>
              
              <tr>
                <td className="px-6 py-2 pl-8 text-sm text-[#171717]/70">- Remboursements d'emprunts</td>
                <td className="px-6 py-2 text-sm text-[#171717]/50"></td>
                <td className="px-6 py-2 text-right text-sm text-[#525252]">-{formatCurrency(cashFlowData.loanRepayments)}</td>
              </tr>
              
              <tr>
                <td className="px-6 py-2 pl-8 text-sm text-[#171717]/70">- Dividendes versés</td>
                <td className="px-6 py-2 text-sm text-[#171717]/50"></td>
                <td className="px-6 py-2 text-right text-sm text-[#525252]">-{formatCurrency(cashFlowData.dividendsPaid)}</td>
              </tr>
              
              <tr className="bg-[#525252]/30 font-bold">
                <td className="px-6 py-4 font-bold text-[#525252]">
                  = FLUX NET DE TRÉSORERIE LIÉ AUX OPÉRATIONS DE FINANCEMENT
                </td>
                <td className="px-6 py-4"></td>
                <td className="px-6 py-4 text-right font-bold text-[#525252] text-lg">
                  {formatCurrency(cashFlowData.financingCashFlow)}
                </td>
              </tr>
              ...
              <tr className="bg-[#525252]/20">
                <td className="px-6 py-3 font-bold text-[#525252]">
                  = VARIATION DE TRÉSORERIE (Flux nets)
                </td>
                <td className="px-6 py-3"></td>
                <td className="px-6 py-3 text-right font-bold text-[#525252] text-lg">
                  {formatCurrency(cashFlowData.cashFlowVariation)}
                </td>
              </tr>
              
              <tr>
                <td className="px-6 py-2 text-sm text-[#171717]/70">Trésorerie d'ouverture</td>
                <td className="px-6 py-2 text-sm text-[#171717]/50"></td>
                <td className="px-6 py-2 text-right text-sm">{formatCurrency(cashFlowData.openingCashBalance)}</td>
              </tr>
              
              <tr>
                <td className="px-6 py-2 text-sm text-[#171717]/70">Trésorerie de clôture</td>
                <td className="px-6 py-2 text-sm text-[#171717]/50"></td>
              ...
              <tr className="bg-[#e5e5e5]">
                <td className="px-6 py-3 font-medium text-[#171717]">
                  CONTRÔLE: Variation calculée (Clôture - Ouverture)
                </td>
                <td className="px-6 py-3"></td>
                <td className="px-6 py-3 text-right font-medium text-[#171717]">
                  {formatCurrency(cashFlowData.cashVariationControl)}
                </td>
              </tr>
              
              <tr className={`${cashFlowData.isCashFlowBalanced ? 'bg-[#171717]/20' : 'bg-red-100'}`}>
                ...
                <td className="px-6 py-3 text-right font-bold">
                  <span className={cashFlowData.isCashFlowBalanced ? 'text-[#171717]' : 'text-red-900'}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-[#f5f5f5] rounded-lg shadow-sm border border-[#e5e5e5] p-6">
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center">
              <span className="text-sm text-[#171717]/70">Free Cash Flow:</span>
              <div className="text-right">
                <span className="text-sm font-bold text-[#171717]">
                  {formatCurrency(cashFlowData.operatingCashFlow + cashFlowData.investmentCashFlow)}
                </span>
                <p className="text-xs text-[#171717]/50">Flux d'exploitation + Investissement</p>
              </div>
            </div>
            
            <div className="flex justify-between items-center">
              <span className="text-sm text-[#171717]/70">Ratio CAF/Investissement:</span>
              <span className="text-sm font-medium">
            ...
            <div className="flex justify-between items-center">
              <span className="text-sm text-[#171717]/70">Couverture des investissements:</span>
              <span className={`text-sm font-medium ${
                cashFlowData.selfFinancingCapacity >= cashFlowData.fixedAssetsAcquisitions ? 'text-[#171717]' : 'text-[#525252]'
              }`}>
            ...
            <div className="flex justify-between items-center">
              <span className="text-sm text-[#171717]/70">Autonomie de financement:</span>
              <span className="text-sm font-medium">
        ...
        <div className="bg-[#f5f5f5] rounded-lg shadow-sm border border-[#e5e5e5] p-6">
          <h3 className="text-lg font-medium text-[#171717] mb-4">Analyse Qualitative</h3>
          <div className="space-y-4">
            {/* Flux d'exploitation */}
            <div className="p-3 rounded-lg bg-[#171717]/10 border border-green-200">
              <div className="flex items-center space-x-2 mb-2">
                <ArrowTrendingUpIcon className="h-4 w-4 text-[#171717]" />
                <span className="text-sm font-medium text-[#171717]">Flux d'Exploitation</span>
              </div>
              <p className="text-xs text-[#171717]/90">
            ...
            {/* Flux d'investissement */}
            <div className="p-3 rounded-lg bg-[#171717]/10 border border-blue-200">
              <div className="flex items-center space-x-2 mb-2">
                <ArrowTrendingDownIcon className="h-4 w-4 text-[#171717]" />
                <span className="text-sm font-medium text-[#171717]">Flux d'Investissement</span>
              </div>
              <p className="text-xs text-[#171717]/90">
            ...
            {/* Flux de financement */}
            <div className="p-3 rounded-lg bg-[#525252]/10 border border-purple-200">
              <div className="flex items-center space-x-2 mb-2">
                <CurrencyDollarIcon className="h-4 w-4 text-[#525252]" />
                <span className="text-sm font-medium text-[#525252]">Flux de Financement</span>
              </div>
              <p className="text-xs text-[#525252]/90">
      ...
      <div className="bg-gray-50 rounded-lg p-4">
        <div className="flex items-start space-x-2">
          ...
          <div className="text-xs text-[#171717]/70">
            <p className="font-medium text-[#171717]/70 mb-2">Note méthodologique:</p>
            <p>
