...
const IncomeStatementSYSCOHADA: React.FC = () => {
  ...
  if (!incomeData) {
    return (
      <div className="text-center p-8">
        <p className="text-[#191919]/50">Aucune donnée de compte de résultat disponible</p>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-6xl mx-auto p-6 space-y-6">
        ...
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-lg font-bold text-[#191919] flex items-center">
              <ChartBarIcon className="h-6 w-6 mr-2 text-[#6A8A82]" />
              COMPTE DE RÉSULTAT SYSCOHADA
            </h1>
            <div className="mt-2 space-y-1">
              <p className="text-lg font-semibold text-[#191919]/90">{incomeData.company.name}</p>
              <p className="text-sm text-[#191919]/70">{incomeData.company.address}</p>
          ...
          <table className="min-w-full">
            ...
            <tbody className="divide-y divide-[#ECECEC]">
              ...
              <tr className="bg-[#B87333]/10">
                <td colSpan={2} className="px-6 py-3 font-bold text-[#B87333] text-lg">CHARGES</td>
                <td className="px-6 py-3"></td>
                {showComparison && <td className="px-6 py-3"></td>}
              </tr>
              
              <tr className="bg-[#B87333]/5">
                <td colSpan={2} className="px-6 py-2 font-semibold text-[#B87333]/90">ACTIVITÉ D'EXPLOITATION</td>
                <td className="px-6 py-2"></td>
                {showComparison && <td className="px-6 py-2"></td>}
              </tr>
              
              <tr>
                <td className="px-6 py-2 pl-8 text-sm text-[#191919]/70">Achats de marchandises</td>
                <td className="px-6 py-2 text-sm text-[#191919]/50">(601)</td>
              ...
              <tr>
                <td className="px-6 py-2 pl-8 text-sm text-[#191919]/70">Variation stocks marchandises</td>
                <td className="px-6 py-2 text-sm text-[#191919]/50">(6031)</td>
              ...
              <tr>
                <td className="px-6 py-2 pl-8 text-sm text-[#191919]/70">Achats de matières premières</td>
                <td className="px-6 py-2 text-sm text-[#191919]/50">(602)</td>
              ...
              <tr>
                <td className="px-6 py-2 pl-8 text-sm text-[#191919]/70">Services extérieurs</td>
                <td className="px-6 py-2 text-sm text-[#191919]/50">(61-62)</td>
              ...
              <tr>
                <td className="px-6 py-2 pl-8 text-sm text-[#191919]/70">Impôts, taxes et versements assimilés</td>
                <td className="px-6 py-2 text-sm text-[#191919]/50">(63)</td>
              ...
              <tr>
                <td className="px-6 py-2 pl-8 text-sm text-[#191919]/70">Charges de personnel</td>
                <td className="px-6 py-2 text-sm text-[#191919]/50">(64)</td>
              ...
              <tr>
                <td className="px-6 py-2 pl-8 text-sm text-[#191919]/70">Autres charges</td>
                <td className="px-6 py-2 text-sm text-[#191919]/50">(65)</td>
              ...
              {/* Activité financière */}
              <tr className="bg-[#B87333]/5">
                <td colSpan={2} className="px-6 py-2 font-semibold text-[#B87333]/90">ACTIVITÉ FINANCIÈRE</td>
                <td className="px-6 py-2"></td>
                {showComparison && <td className="px-6 py-2"></td>}
              </tr>
              
              <tr>
                <td className="px-6 py-2 pl-8 text-sm text-[#191919]/70">Charges financières</td>
                <td className="px-6 py-2 text-sm text-[#191919]/50">(67)</td>
              ...
              {/* Activité exceptionnelle */}
              <tr className="bg-[#B87333]/5">
                <td colSpan={2} className="px-6 py-2 font-semibold text-[#B87333]/90">ACTIVITÉ EXCEPTIONNELLE</td>
                <td className="px-6 py-2"></td>
                {showComparison && <td className="px-6 py-2"></td>}
              </tr>
              
              <tr>
                <td className="px-6 py-2 pl-8 text-sm text-[#191919]/70">Charges exceptionnelles (HAO)</td>
                <td className="px-6 py-2 text-sm text-[#191919]/50">(81-85)</td>
              ...
              <tr>
                <td className="px-6 py-2 pl-8 text-sm text-[#191919]/70">Impôts sur le résultat</td>
                <td className="px-6 py-2 text-sm text-[#191919]/50">(89)</td>
              ...
              {/* Total charges */}
              <tr className="bg-[#B87333]/20 font-bold">
                <td colSpan={2} className="px-6 py-3 text-[#B87333]">TOTAL CHARGES</td>
                <td className="px-6 py-3 text-right text-[#B87333]">{formatCurrency(incomeData.totalExpenses)}</td>
                {showComparison && <td className="px-6 py-3 text-right text-[#B87333]">8,968,000</td>}
              </tr>
              ...
              <tr className="bg-[#6A8A82]/10">
                <td colSpan={2} className="px-6 py-3 font-bold text-[#6A8A82] text-lg">PRODUITS</td>
                <td className="px-6 py-3"></td>
                {showComparison && <td className="px-6 py-3"></td>}
              </tr>
              
              <tr className="bg-[#6A8A82]/5">
                <td colSpan={2} className="px-6 py-2 font-semibold text-[#6A8A82]/90">ACTIVITÉ D'EXPLOITATION</td>
                <td className="px-6 py-2"></td>
                {showComparison && <td className="px-6 py-2"></td>}
              </tr>
              
              <tr>
                <td className="px-6 py-2 pl-8 text-sm text-[#191919]/70">Ventes de marchandises</td>
                <td className="px-6 py-2 text-sm text-[#191919]/50">(701)</td>
              ...
              <tr>
                <td className="px-6 py-2 pl-8 text-sm text-[#191919]/70">Production vendue</td>
                <td className="px-6 py-2 text-sm text-[#191919]/50">(702-708)</td>
              ...
              <tr>
                <td className="px-6 py-2 pl-8 text-sm text-[#191919]/70">Production stockée</td>
                <td className="px-6 py-2 text-sm text-[#191919]/50">(713-714)</td>
              ...
              <tr>
                <td className="px-6 py-2 pl-8 text-sm text-[#191919]/70">Production immobilisée</td>
                <td className="px-6 py-2 text-sm text-[#191919]/50">(72)</td>
              ...
              <tr>
                <td className="px-6 py-2 pl-8 text-sm text-[#191919]/70">Subventions d'exploitation</td>
                <td className="px-6 py-2 text-sm text-[#191919]/50">(74)</td>
              ...
              <tr>
                <td className="px-6 py-2 pl-8 text-sm text-[#191919]/70">Autres produits</td>
                <td className="px-6 py-2 text-sm text-[#191919]/50">(75)</td>
              ...
              {/* Activité financière */}
              <tr className="bg-[#6A8A82]/5">
                <td colSpan={2} className="px-6 py-2 font-semibold text-[#6A8A82]/90">ACTIVITÉ FINANCIÈRE</td>
                <td className="px-6 py-2"></td>
                {showComparison && <td className="px-6 py-2"></td>}
              </tr>
              
              <tr>
                <td className="px-6 py-2 pl-8 text-sm text-[#191919]/70">Produits financiers</td>
                <td className="px-6 py-2 text-sm text-[#191919]/50">(77)</td>
              ...
              {/* Activité exceptionnelle */}
              <tr className="bg-[#6A8A82]/5">
                <td colSpan={2} className="px-6 py-2 font-semibold text-[#6A8A82]/90">ACTIVITÉ EXCEPTIONNELLE</td>
                <td className="px-6 py-2"></td>
                {showComparison && <td className="px-6 py-2"></td>}
              </tr>
              
              <tr>
                <td className="px-6 py-2 pl-8 text-sm text-[#191919]/70">Produits exceptionnels (HAO)</td>
                <td className="px-6 py-2 text-sm text-[#191919]/50">(82-88)</td>
              ...
              <tr className="bg-[#6A8A82]/20 font-bold">
                <td colSpan={2} className="px-6 py-3 text-[#6A8A82]">TOTAL PRODUITS</td>
                <td className="px-6 py-3 text-right text-[#6A8A82]">{formatCurrency(incomeData.totalIncome)}</td>
                {showComparison && <td className="px-6 py-3 text-right text-[#6A8A82]">11,858,000</td>}
              </tr>
              
              {/* RÉSULTAT NET */}
              <tr className="bg-[#6A8A82]/20 font-bold text-lg">
                <td colSpan={2} className="px-6 py-4 text-[#F0F3F2]">RÉSULTAT NET DE L'EXERCICE</td>
                <td className="px-6 py-4 text-right text-[#F0F3F2]">
                  {formatCurrency(incomeData.calculatedNetResult)}
                </td>
                {showComparison && <td className="px-6 py-4 text-right text-[#F0F3F2]">2,890,000</td>}
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <div className="bg-[#F0F3F2] rounded-lg shadow-sm border border-[#ECECEC] p-6">
        <h2 className="text-lg font-medium text-[#191919] mb-4 flex items-center">
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-[#ECECEC]">
            <thead className="bg-[#ECECEC]">
              <tr>
                <th className="px-6 py-3 text-left text-sm font-medium text-[#191919]/50">{t('accounting.balance')}</th>
                <th className="px-6 py-3 text-right text-sm font-medium text-[#191919]/50">Montant (XAF)</th>
                <th className="px-6 py-3 text-right text-sm font-medium text-[#191919]/50">% du CA</th>
                <th className="px-6 py-3 text-right text-sm font-medium text-[#191919]/50">Évolution</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-[#ECECEC]">
              <tr>
                <td className="px-6 py-3 text-sm font-medium text-[#191919]">1. Marge commerciale</td>
                ...
                <td className="px-6 py-3 text-right">
                  <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-[#6A8A82]/20 text-[#6A8A82]/90">
              ...
              <tr>
                <td className="px-6 py-3 text-sm font-medium text-[#191919]">2. Production de l'exercice</td>
              ...
              <tr className="bg-[#6A8A82]/10">
                <td className="px-6 py-3 text-sm font-semibold text-[#6A8A82]">4. Excédent brut d'exploitation (EBE)</td>
                <td className="px-6 py-3 text-right text-sm font-semibold text-[#6A8A82]">{formatCurrency(grossOperatingSurplus)}</td>
                <td className="px-6 py-3 text-right text-sm font-semibold text-[#6A8A82]">{calculateMargin(grossOperatingSurplus, incomeData.totalIncome)}%</td>
                <td className="px-6 py-3 text-right">
              ...
              <tr>
                <td className="px-6 py-3 text-sm font-medium text-[#191919]">5. Résultat d'exploitation</td>
              ...
              <tr>
                <td className="px-6 py-3 text-sm font-medium text-[#191919]">6. Résultat financier</td>
                <td className="px-6 py-3 text-right text-sm font-medium">
                  <span className={financialResult >= 0 ? 'text-green-600' : 'text-[#B87333]'}>
                ...
                <td className="px-6 py-3 text-right">
                  <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-[#B87333]/20 text-[#B87333]/90">
              ...
              <tr>
                <td className="px-6 py-3 text-sm font-medium text-[#191919]">7. Résultat courant avant impôts</td>
              ...
              <tr>
                <td className="px-6 py-3 text-sm font-medium text-[#191919]">8. Résultat exceptionnel</td>
                <td className="px-6 py-3 text-right text-sm font-medium">
                  <span className={exceptionalResult >= 0 ? 'text-green-600' : 'text-[#B87333]'}>
              ...
              {/* RÉSULTAT NET FINAL */}
              <tr className="bg-[#6A8A82]/20 font-bold text-lg">
                <td className="px-6 py-4 text-[#F0F3F2]">9. RÉSULTAT NET</td>
                <td className="px-6 py-4 text-right text-[#F0F3F2]">{formatCurrency(incomeData.calculatedNetResult)}</td>
                <td className="px-6 py-4 text-right text-[#F0F3F2]">{calculateMargin(incomeData.calculatedNetResult, incomeData.totalIncome)}%</td>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-[#F0F3F2] rounded-lg shadow-sm border border-[#ECECEC] p-6">
          <h3 className="text-lg font-medium text-[#191919] mb-4">Analyse de Rentabilité</h3>
          <div className="space-y-3">
            <div className="flex justify-between items-center">
              <span className="text-sm text-[#191919]/70">Marge commerciale:</span>
            ...
            <div className="flex justify-between items-center">
              <span className="text-sm text-[#191919]/70">Marge d'exploitation:</span>
              <div className="text-right">
            ...
            <div className="flex justify-between items-center">
              <span className="text-sm text-[#191919]/70">Marge nette:</span>
              <div className="text-right">
                <span className="text-sm font-medium text-[#6A8A82]">{calculateMargin(incomeData.calculatedNetResult, incomeData.totalIncome)}%</span>
                <div className="w-20 bg-gray-200 rounded-full h-2 mt-1">
                  <div 
                    className="bg-[#6A8A82]0 h-2 rounded-full"
        ...
        <div className="bg-[#F0F3F2] rounded-lg shadow-sm border border-[#ECECEC] p-6">
          <h3 className="text-lg font-medium text-[#191919] mb-4">Structure des Coûts</h3>
          <div className="space-y-3">
            <div className="flex justify-between">
              <span className="text-sm text-[#191919]/70">Achats et consommations:</span>
              <span className="text-sm font-medium">
            ...
            <div className="flex justify-between">
              <span className="text-sm text-[#191919]/70">Charges de personnel:</span>
              <span className="text-sm font-medium">
                {(incomeData.staffCosts / incomeData.totalExpenses * 100).toFixed(1)}%
              </span>
            </div>
            <div className="flex justify-between">
              <span className="text-sm text-[#191919]/70">Services extérieurs:</span>
              <span className="text-sm font-medium">
                {(incomeData.externalServices / incomeData.totalExpenses * 100).toFixed(1)}%
              </span>
            </div>
            <div className="flex justify-between">
              <span className="text-sm text-[#191919]/70">Charges financières:</span>
              <span className="text-sm font-medium">
