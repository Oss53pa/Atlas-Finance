...
const IncomeStatementSYSCOHADA: React.FC = () => {
  ...
  if (!incomeData) {
    return (
      <div className="text-center p-8">
        <p className="text-[var(--color-primary)]/50">Aucune donnée de compte de résultat disponible</p>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-6xl mx-auto p-6 space-y-6">
        ...
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-lg font-bold text-[var(--color-primary)] flex items-center">
              <ChartBarIcon className="h-6 w-6 mr-2 text-[var(--color-primary)]" />
              COMPTE DE RÉSULTAT SYSCOHADA
            </h1>
            <div className="mt-2 space-y-1">
              <p className="text-lg font-semibold text-[var(--color-primary)]/90">{incomeData.company.name}</p>
              <p className="text-sm text-[var(--color-primary)]/70">{incomeData.company.address}</p>
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full">
            <thead className="bg-[var(--color-primary)]">
              <tr>
                <th colSpan={2} className="px-6 py-4 text-center text-lg font-bold text-[var(--color-surface-hover)] border-b-2 border-[var(--color-primary)]">
                  COMPTE DE RÉSULTAT AU {new Date(incomeData.statementDate).toLocaleDateString('fr-FR')}
                </th>
                <th className="px-6 py-4 text-center text-lg font-bold text-[var(--color-surface-hover)] border-b-2 border-[var(--color-primary)]">
            ...
            <tbody className="divide-y divide-[var(--color-border)]">
              ...
              <tr className="bg-[var(--color-text-secondary)]/10">
                <td colSpan={2} className="px-6 py-3 font-bold text-[var(--color-text-secondary)] text-lg">CHARGES</td>
                <td className="px-6 py-3"></td>
                {showComparison && <td className="px-6 py-3"></td>}
              </tr>
              
              <tr className="bg-[var(--color-text-secondary)]/5">
                <td colSpan={2} className="px-6 py-2 font-semibold text-[var(--color-text-secondary)]/90">ACTIVITÉ D'EXPLOITATION</td>
                <td className="px-6 py-2"></td>
                {showComparison && <td className="px-6 py-2"></td>}
              </tr>
              
              <tr>
                <td className="px-6 py-2 pl-8 text-sm text-[var(--color-primary)]/70">Achats de marchandises</td>
                <td className="px-6 py-2 text-sm text-[var(--color-primary)]/50">(601)</td>
              ...
              <tr>
                <td className="px-6 py-2 pl-8 text-sm text-[var(--color-primary)]/70">Variation stocks marchandises</td>
                <td className="px-6 py-2 text-sm text-[var(--color-primary)]/50">(6031)</td>
              ...
              <tr>
                <td className="px-6 py-2 pl-8 text-sm text-[var(--color-primary)]/70">Achats de matières premières</td>
                <td className="px-6 py-2 text-sm text-[var(--color-primary)]/50">(602)</td>
              ...
              <tr>
                <td className="px-6 py-2 pl-8 text-sm text-[var(--color-primary)]/70">Services extérieurs</td>
                <td className="px-6 py-2 text-sm text-[var(--color-primary)]/50">(61-62)</td>
              ...
              <tr>
                <td className="px-6 py-2 pl-8 text-sm text-[var(--color-primary)]/70">Impôts, taxes et versements assimilés</td>
                <td className="px-6 py-2 text-sm text-[var(--color-primary)]/50">(63)</td>
              ...
              <tr>
                <td className="px-6 py-2 pl-8 text-sm text-[var(--color-primary)]/70">Charges de personnel</td>
                <td className="px-6 py-2 text-sm text-[var(--color-primary)]/50">(64)</td>
              ...
              <tr>
                <td className="px-6 py-2 pl-8 text-sm text-[var(--color-primary)]/70">Autres charges</td>
                <td className="px-6 py-2 text-sm text-[var(--color-primary)]/50">(65)</td>
              ...
              {/* Activité financière */}
              <tr className="bg-[var(--color-text-secondary)]/5">
                <td colSpan={2} className="px-6 py-2 font-semibold text-[var(--color-text-secondary)]/90">ACTIVITÉ FINANCIÈRE</td>
                <td className="px-6 py-2"></td>
                {showComparison && <td className="px-6 py-2"></td>}
              </tr>
              
              <tr>
                <td className="px-6 py-2 pl-8 text-sm text-[var(--color-primary)]/70">Charges financières</td>
                <td className="px-6 py-2 text-sm text-[var(--color-primary)]/50">(67)</td>
              ...
              {/* Activité exceptionnelle */}
              <tr className="bg-[var(--color-text-secondary)]/5">
                <td colSpan={2} className="px-6 py-2 font-semibold text-[var(--color-text-secondary)]/90">ACTIVITÉ EXCEPTIONNELLE</td>
                <td className="px-6 py-2"></td>
                {showComparison && <td className="px-6 py-2"></td>}
              </tr>
              
              <tr>
                <td className="px-6 py-2 pl-8 text-sm text-[var(--color-primary)]/70">Charges exceptionnelles (HAO)</td>
                <td className="px-6 py-2 text-sm text-[var(--color-primary)]/50">(81-85)</td>
              ...
              <tr>
                <td className="px-6 py-2 pl-8 text-sm text-[var(--color-primary)]/70">Impôts sur le résultat</td>
                <td className="px-6 py-2 text-sm text-[var(--color-primary)]/50">(89)</td>
              ...
              {/* Total charges */}
              <tr className="bg-[var(--color-text-secondary)]/20 font-bold">
                <td colSpan={2} className="px-6 py-3 text-[var(--color-text-secondary)]">TOTAL CHARGES</td>
                <td className="px-6 py-3 text-right text-[var(--color-text-secondary)]">{fmt(incomeData.totalExpenses)}</td>
                {showComparison && <td className="px-6 py-3 text-right text-[var(--color-text-secondary)]">8,968,000</td>}
              </tr>
              ...
              <tr className="bg-[var(--color-primary)]/10">
                <td colSpan={2} className="px-6 py-3 font-bold text-[var(--color-primary)] text-lg">PRODUITS</td>
                <td className="px-6 py-3"></td>
                {showComparison && <td className="px-6 py-3"></td>}
              </tr>
              
              <tr className="bg-[var(--color-primary)]/5">
                <td colSpan={2} className="px-6 py-2 font-semibold text-[var(--color-primary)]/90">ACTIVITÉ D'EXPLOITATION</td>
                <td className="px-6 py-2"></td>
                {showComparison && <td className="px-6 py-2"></td>}
              </tr>
              
              <tr>
                <td className="px-6 py-2 pl-8 text-sm text-[var(--color-primary)]/70">Ventes de marchandises</td>
                <td className="px-6 py-2 text-sm text-[var(--color-primary)]/50">(701)</td>
              ...
              <tr>
                <td className="px-6 py-2 pl-8 text-sm text-[var(--color-primary)]/70">Production vendue</td>
                <td className="px-6 py-2 text-sm text-[var(--color-primary)]/50">(702-708)</td>
              ...
              <tr>
                <td className="px-6 py-2 pl-8 text-sm text-[var(--color-primary)]/70">Production stockée</td>
                <td className="px-6 py-2 text-sm text-[var(--color-primary)]/50">(713-714)</td>
              ...
              <tr>
                <td className="px-6 py-2 pl-8 text-sm text-[var(--color-primary)]/70">Production immobilisée</td>
                <td className="px-6 py-2 text-sm text-[var(--color-primary)]/50">(72)</td>
              ...
              <tr>
                <td className="px-6 py-2 pl-8 text-sm text-[var(--color-primary)]/70">Subventions d'exploitation</td>
                <td className="px-6 py-2 text-sm text-[var(--color-primary)]/50">(74)</td>
              ...
              <tr>
                <td className="px-6 py-2 pl-8 text-sm text-[var(--color-primary)]/70">Autres produits</td>
                <td className="px-6 py-2 text-sm text-[var(--color-primary)]/50">(75)</td>
              ...
              {/* Activité financière */}
              <tr className="bg-[var(--color-primary)]/5">
                <td colSpan={2} className="px-6 py-2 font-semibold text-[var(--color-primary)]/90">ACTIVITÉ FINANCIÈRE</td>
                <td className="px-6 py-2"></td>
                {showComparison && <td className="px-6 py-2"></td>}
              </tr>
              
              <tr>
                <td className="px-6 py-2 pl-8 text-sm text-[var(--color-primary)]/70">Produits financiers</td>
                <td className="px-6 py-2 text-sm text-[var(--color-primary)]/50">(77)</td>
              ...
              {/* Activité exceptionnelle */}
              <tr className="bg-[var(--color-primary)]/5">
                <td colSpan={2} className="px-6 py-2 font-semibold text-[var(--color-primary)]/90">ACTIVITÉ EXCEPTIONNELLE</td>
                <td className="px-6 py-2"></td>
                {showComparison && <td className="px-6 py-2"></td>}
              </tr>
              
              <tr>
                <td className="px-6 py-2 pl-8 text-sm text-[var(--color-primary)]/70">Produits exceptionnels (HAO)</td>
                <td className="px-6 py-2 text-sm text-[var(--color-primary)]/50">(82-88)</td>
              ...
              <tr className="bg-[var(--color-primary)]/20 font-bold">
                <td colSpan={2} className="px-6 py-3 text-[var(--color-primary)]">TOTAL PRODUITS</td>
                <td className="px-6 py-3 text-right text-[var(--color-primary)]">{fmt(incomeData.totalIncome)}</td>
                {showComparison && <td className="px-6 py-3 text-right text-[var(--color-primary)]">11,858,000</td>}
              </tr>
              
              {/* RÉSULTAT NET */}
              <tr className="bg-[var(--color-primary)]/20 font-bold text-lg">
                <td colSpan={2} className="px-6 py-4 text-[var(--color-surface-hover)]">RÉSULTAT NET DE L'EXERCICE</td>
                <td className="px-6 py-4 text-right text-[var(--color-surface-hover)]">
                  {fmt(incomeData.calculatedNetResult)}
                </td>
                {showComparison && <td className="px-6 py-4 text-right text-[var(--color-surface-hover)]">2,890,000</td>}
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <div className="bg-[var(--color-surface-hover)] rounded-lg shadow-sm border border-[var(--color-border)] p-6">
        <h2 className="text-lg font-medium text-[var(--color-primary)] mb-4 flex items-center">
          <CalculatorIcon className="h-5 w-5 mr-2 text-[var(--color-primary)]" />
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-[var(--color-border)]">
            <thead className="bg-[var(--color-border)]">
              <tr>
                <th className="px-6 py-3 text-left text-sm font-medium text-[var(--color-primary)]/50">{t('accounting.balance')}</th>
                <th className="px-6 py-3 text-right text-sm font-medium text-[var(--color-primary)]/50">Montant (XAF)</th>
                <th className="px-6 py-3 text-right text-sm font-medium text-[var(--color-primary)]/50">% du CA</th>
                <th className="px-6 py-3 text-right text-sm font-medium text-[var(--color-primary)]/50">Évolution</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-[var(--color-border)]">
              <tr>
                <td className="px-6 py-3 text-sm font-medium text-[var(--color-primary)]">1. Marge commerciale</td>
                ...
                <td className="px-6 py-3 text-right">
                  <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-[var(--color-primary)]/20 text-[var(--color-primary)]/90">
              ...
              <tr>
                <td className="px-6 py-3 text-sm font-medium text-[var(--color-primary)]">2. Production de l'exercice</td>
              ...
              <tr className="bg-[var(--color-primary)]/10">
                <td className="px-6 py-3 text-sm font-semibold text-[var(--color-primary)]">4. Excédent brut d'exploitation (EBE)</td>
                <td className="px-6 py-3 text-right text-sm font-semibold text-[var(--color-primary)]">{fmt(grossOperatingSurplus)}</td>
                <td className="px-6 py-3 text-right text-sm font-semibold text-[var(--color-primary)]">{calculateMargin(grossOperatingSurplus, incomeData.totalIncome)}%</td>
                <td className="px-6 py-3 text-right">
              ...
              <tr>
                <td className="px-6 py-3 text-sm font-medium text-[var(--color-primary)]">5. Résultat d'exploitation</td>
              ...
              <tr>
                <td className="px-6 py-3 text-sm font-medium text-[var(--color-primary)]">6. Résultat financier</td>
                <td className="px-6 py-3 text-right text-sm font-medium">
                  <span className={financialResult >= 0 ? 'text-green-600' : 'text-[var(--color-text-secondary)]'}>
                    {fmt(financialResult)}
                  </span>
                </td>
                <td className="px-6 py-3 text-right text-sm">{calculateMargin(financialResult, incomeData.totalIncome)}%</td>
                <td className="px-6 py-3 text-right">
                  <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-[var(--color-text-secondary)]/20 text-[var(--color-text-secondary)]/90">
              ...
              <tr>
                <td className="px-6 py-3 text-sm font-medium text-[var(--color-primary)]">7. Résultat courant avant impôts</td>
              ...
              <tr>
                <td className="px-6 py-3 text-sm font-medium text-[var(--color-primary)]">8. Résultat exceptionnel</td>
                <td className="px-6 py-3 text-right text-sm font-medium">
                  <span className={exceptionalResult >= 0 ? 'text-green-600' : 'text-[var(--color-text-secondary)]'}>
              ...
              {/* RÉSULTAT NET FINAL */}
              <tr className="bg-[var(--color-primary)]/20 font-bold text-lg">
                <td className="px-6 py-4 text-[var(--color-surface-hover)]">9. RÉSULTAT NET</td>
                <td className="px-6 py-4 text-right text-[var(--color-surface-hover)]">{fmt(incomeData.calculatedNetResult)}</td>
                <td className="px-6 py-4 text-right text-[var(--color-surface-hover)]">{calculateMargin(incomeData.calculatedNetResult, incomeData.totalIncome)}%</td>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-[var(--color-surface-hover)] rounded-lg shadow-sm border border-[var(--color-border)] p-6">
          <h3 className="text-lg font-medium text-[var(--color-primary)] mb-4">Analyse de Rentabilité</h3>
          <div className="space-y-3">
            <div className="flex justify-between items-center">
              <span className="text-sm text-[var(--color-primary)]/70">Marge commerciale:</span>
            ...
            <div className="flex justify-between items-center">
              <span className="text-sm text-[var(--color-primary)]/70">Marge d'exploitation:</span>
              <div className="text-right">
            ...
            <div className="flex justify-between items-center">
              <span className="text-sm text-[var(--color-primary)]/70">Marge nette:</span>
              <div className="text-right">
                <span className="text-sm font-medium text-[var(--color-primary)]">{calculateMargin(incomeData.calculatedNetResult, incomeData.totalIncome)}%</span>
                <div className="w-20 bg-gray-200 rounded-full h-2 mt-1">
                  <div 
                    className="bg-[var(--color-primary)]0 h-2 rounded-full"
        ...
        <div className="bg-[var(--color-surface-hover)] rounded-lg shadow-sm border border-[var(--color-border)] p-6">
          <h3 className="text-lg font-medium text-[var(--color-primary)] mb-4">Structure des Coûts</h3>
          <div className="space-y-3">
            <div className="flex justify-between">
              <span className="text-sm text-[var(--color-primary)]/70">Achats et consommations:</span>
              <span className="text-sm font-medium">
            ...
            <div className="flex justify-between">
              <span className="text-sm text-[var(--color-primary)]/70">Charges de personnel:</span>
              <span className="text-sm font-medium">
                {(incomeData.staffCosts / incomeData.totalExpenses * 100).toFixed(1)}%
              </span>
            </div>
            <div className="flex justify-between">
              <span className="text-sm text-[var(--color-primary)]/70">Services extérieurs:</span>
              <span className="text-sm font-medium">
                {(incomeData.externalServices / incomeData.totalExpenses * 100).toFixed(1)}%
              </span>
            </div>
            <div className="flex justify-between">
              <span className="text-sm text-[var(--color-primary)]/70">Charges financières:</span>
              <span className="text-sm font-medium">
