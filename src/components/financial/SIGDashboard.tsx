            ...
            <div className="space-y-4">
              <div className="border-b border-gray-100 pb-3">
                ...
                <div className="text-xs text-gray-600 mt-1">
                  Ventes: {fmt(sigData.merchandiseSales)} - Coût: {fmt(sigData.merchandiseCost)}
                </div>
              </div>
              ...
              <div className="border-b border-gray-100 pb-3">
                ...
                <div className="text-xs text-gray-600 mt-1">
                  Vendue: {fmt(sigData.productionSold)} + Stockée: {fmt(sigData.productionStored)}
                </div>
              </div>
              ...
              <div className="border-b border-gray-100 pb-3">
                ...
                <div className="text-xs text-gray-600 mt-1">
                  VA - Personnel ({fmt(sigData.staffCosts)}) - Impôts ({fmt(sigData.taxesAndDuties)})
                </div>
              </div>
