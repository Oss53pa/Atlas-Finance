...
const MultiCompanyManager: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto p-6 space-y-6">
      {/* Header */}
      <div className="bg-[var(--color-primary)] rounded-lg shadow-sm border border-gray-200 p-6">
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-[var(--color-surface-hover)] mt-2">Configuration GROUPE → HOLDING → FILIALES → ÉTABLISSEMENTS</p>
          </div>
          <div className="flex space-x-4">
            <select
              value={viewMode}
              onChange={(e) => setViewMode(e.target.value as 'tree' | 'list' | 'consolidation')}
              className="px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[var(--color-primary)]"
            >
            ...
            <button
              ...
              className="bg-[var(--color-text-secondary)] hover:bg-[var(--color-primary)] text-white px-4 py-2 rounded-lg flex items-center space-x-2 transition-colors"
            >
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        {[
          ...
          <div key={index} className="bg-[var(--color-surface-hover)] p-6 rounded-lg shadow-sm border border-gray-200">
      ...
      {viewMode === 'tree' && (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            <div className="bg-[var(--color-surface-hover)] rounded-lg shadow-sm border border-gray-200 p-6">
              <h2 className="text-lg font-bold text-[var(--color-primary)] mb-4">Structure Organisationnelle</h2>
              <div className="space-y-2">
            ...
            {selectedCompany && (() => {
              ...
              return (
                <>
                  ...
                  <div className="bg-[var(--color-border)] rounded-lg shadow-sm border border-gray-200 p-6">
                    <h3 className="text-lg font-medium text-[var(--color-primary)] mb-4">Informations Générales</h3>
                  ...
                  {/* Configuration */}
                  <div className="bg-[var(--color-border)] rounded-lg shadow-sm border border-gray-200 p-6">
                    <h3 className="text-lg font-medium text-[var(--color-primary)] mb-4">Configuration</h3>
                  ...
                  <div className="bg-[var(--color-border)] rounded-lg shadow-sm border border-gray-200 p-6">
                    <h3 className="text-lg font-medium text-[var(--color-primary)] mb-4 flex items-center">
      ...
      {viewMode === 'consolidation' && (
        <div className="bg-[var(--color-surface-hover)] rounded-lg shadow-sm border border-gray-200 p-6">
          <div className="flex justify-between items-center mb-6">
            ...
            <button className="bg-[var(--color-text-secondary)] hover:bg-[var(--color-primary)] text-white px-4 py-2 rounded-lg flex items-center space-x-2">
              <PlusIcon className="h-5 w-5" />
