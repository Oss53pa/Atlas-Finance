...
const CompleteTasksModule: React.FC = () => {
  ...
  // doivent etre creees par l'utilisateur via "Nouvelle tache" ou
  // viendront d'une integration future avec une table Supabase.
  ...
  const getStatusColor = (status: string) => {
    const colors = {
      ...
      'in-progress': 'bg-[var(--color-primary)]/10 text-[var(--color-primary)]',
          ...
          <div className="flex justify-between items-start">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 bg-[var(--color-text-secondary)] text-white rounded-lg hover:bg-[#404040] transition-colors"
              >
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="pl-10 pr-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[var(--color-text-secondary)]/50 w-64"
                />
              </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <select
                ...
                className="px-3 py-1.5 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[var(--color-text-secondary)]/50"
              >
              ...
              <div className="flex bg-white border rounded-lg">
                <button
                  ...
                  className={`p-2 ${viewMode === 'kanban' ? 'bg-[var(--color-text-secondary)] text-white' : 'text-gray-600'} rounded-l-lg transition-colors`}
                >
                  <Kanban className="w-4 h-4" />
                </button>
                <button
                  onClick={() => setViewMode('list')}
                  className={`p-2 ${viewMode === 'list' ? 'bg-[var(--color-text-secondary)] text-white' : 'text-gray-600'} transition-colors`}
                >
                  <List className="w-4 h-4" />
                </button>
                <button
                  onClick={() => setViewMode('calendar')}
                  className={`p-2 ${viewMode === 'calendar' ? 'bg-[var(--color-text-secondary)] text-white' : 'text-gray-600'} transition-colors`}
                >
                  <CalendarDays className="w-4 h-4" />
                </button>
                <button
                  onClick={() => setViewMode('timeline')}
                  className={`p-2 ${viewMode === 'timeline' ? 'bg-[var(--color-text-secondary)] text-white' : 'text-gray-600'} rounded-r-lg transition-colors`}
                >
      ...
      {showStatistics && (
        <div className="bg-white border-b px-6 py-4">
          <div className="grid grid-cols-8 gap-4">
            ...
            <div className="text-center">
              <div className="text-lg font-bold text-[var(--color-primary)]">{statistics.inProgress}</div>
            ...
            <div className="text-center">
              <div className="text-lg font-bold text-[var(--color-text-secondary)]">{statistics.avgProgress}%</div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[var(--color-text-secondary)]/50"
