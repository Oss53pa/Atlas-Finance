        ...
        <div className="flex items-center gap-4 mt-4">
          <div className="relative flex-1 max-w-md">
            ...
            <input
              ...
              className="pl-10 pr-4 py-2 w-full border rounded-lg focus:outline-none focus:ring-2 focus:ring-[var(--color-text-secondary)]/50"
            />
          </div>
        ...
        <div className="grid grid-cols-4 gap-4">
          ...
          <div className="bg-[var(--color-primary)]/5 rounded-lg p-4">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="bg-[var(--color-primary)]/20 px-2 py-1 rounded-full text-xs text-[var(--color-primary)]">
