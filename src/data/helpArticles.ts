...
**Attention** : une clôture mensuelle peut être réouverte par un administrateur, mais une **clôture annuelle est définitive** (Art. 19 SYSCOHADA).`,
  },
  {
    id: 'tva-calculation',
...
La VNC ne peut jamais être négative.`,
  },
  {
    id: 'lettrage',
...
Les rapprochements clôturés ne peuvent pas être modifiés.`,
  },
  {
    id: 'export-fec',
