  ...
  if (loading) {
    return (
      <div className="w-full h-[400px] bg-[#F5F5F5] rounded-lg animate-pulse flex items-center justify-center">
        <p className="text-[#767676]">Chargement du graphique...</p>
      </div>
    );
  }
  ...
  if (!data || data.length === 0) {
    return (
      <div className="w-full h-[400px] bg-[#F5F5F5] rounded-lg flex items-center justify-center">
        <p className="text-[#767676]">Aucune donnée disponible</p>
      </div>
    );
  }
    ...
    return (
      <div className="bg-white border border-[#D9D9D9] rounded-lg shadow-lg p-3">
        ...
        {payload[0].payload.variance !== undefined && (
          <p className="text-sm text-[#767676] mt-1 pt-1 border-t border-[#D9D9D9]">
