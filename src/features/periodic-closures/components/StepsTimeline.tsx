      ...
      {steps.map((step, index) => (
        ...
        >
          {index < steps.length - 1 && (
            <div className="absolute left-6 top-14 bottom-[-16px] w-0.5 bg-[var(--color-border)]" />
          )}
            ...
            <div className="flex items-start justify-between">
              <div className="flex-1">
                <div className="flex items-center gap-2">
                  <h4 className="font-semibold text-[var(--color-primary)]">{step.name}</h4>
                  {step.mandatory && (
                ...
                <p className="text-sm text-[var(--color-text-tertiary)] mt-1">{step.description}</p>
