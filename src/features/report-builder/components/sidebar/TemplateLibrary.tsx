...
const templates: ReportTemplate[] = [
  {
    ...
    generateBlocks: () => [
      { id: uid(), type: 'cover', locked: false, style: { marginBottom: 0 }, companyName: 'Atlas FnA', reportTitle: 'Rapport Mensuel de Direction', subtitle: '', backgroundStyle: 'corporate-classic', confidentiality: 'confidentiel' } as ReportBlock,
  ...
  },
  {
    ...
    generateBlocks: () => [
      { id: uid(), type: 'cover', locked: false, style: { marginBottom: 0 }, companyName: 'Atlas FnA', reportTitle: 'Rapport EXCO', subtitle: 'Comité de Direction', backgroundStyle: 'executive-dark', confidentiality: 'confidentiel' } as ReportBlock,
  ...
  },
  {
    ...
    generateBlocks: () => [
      { id: uid(), type: 'cover', locked: false, style: { marginBottom: 0 }, companyName: 'Atlas FnA', reportTitle: 'Rapport Annuel', subtitle: 'Exercice 2025', backgroundStyle: 'finance-modern', confidentiality: 'confidentiel' } as ReportBlock,
  ...
  },
  {
    ...
    generateBlocks: () => [
      { id: uid(), type: 'cover', locked: false, style: { marginBottom: 0 }, companyName: 'Atlas FnA', reportTitle: 'Rapport Financier', subtitle: 'À l\'attention de nos partenaires bancaires', backgroundStyle: 'formal', confidentiality: 'confidentiel' } as ReportBlock,
