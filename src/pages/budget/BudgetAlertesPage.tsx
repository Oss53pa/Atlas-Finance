...
const SEV_STYLE: Record<AlertSeverity, string> = {
  ...
  P3: 'bg-[var(--color-primary-light)] text-[var(--color-primary)] dark:text-[var(--color-primary)]',
};
    ...
    <div className="p-6 space-y-5">
      ...
      {loading ? (
        ...
        <div className="space-y-2">
          {alerts.map((a, i) => (
            <div key={i} className="bg-[var(--color-surface)] rounded-xl border border-[var(--color-border)] px-4 py-3 flex items-center gap-3">
