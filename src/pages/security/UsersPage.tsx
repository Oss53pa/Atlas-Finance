...
const UsersPage: React.FC = () => {
  ...
  const handleDelete = (user: User) => {
    if (window.confirm(`Êtes-vous sûr de vouloir supprimer l'utilisateur ${user.firstName} ${user.lastName} ? Cette action est irréversible.`)) {
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center space-x-1">
                        ...
                        {user.is2FAEnabled ? (
                          ...
                          <KeyIcon className="h-4 w-4 text-gray-400" title="2FA désactivé" />
                        )}
