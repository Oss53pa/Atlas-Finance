            ...
            <div className="bg-white rounded-lg p-6 border border-[var(--color-border)] shadow-sm">
              ...
              <ResponsiveContainer width="100%" height={300}>
                <BarChart data={analyticsData.activiteParJour}>
                  ...
                  <Tooltip />
                  <Legend />
                  <Bar radius={[6,6,0,0]} dataKey="messages" name="Messages" fill="url(#gradPetrol)" />
                  <Bar radius={[6,6,0,0]} dataKey="collaborations" name="Collaborations" fill="url(#gradPetrolLight)" />
                </BarChart>
              </ResponsiveContainer>
            </div>
