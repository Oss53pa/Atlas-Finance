      ...
      <header className="bg-white border-b sticky top-0 z-50">
        <div className="flex items-center justify-between px-6 py-3">
          <div className="flex items-center space-x-4">
            ...
            <div className="hidden md:flex items-center space-x-2 px-3 py-1 rounded-lg bg-orange-50"><Briefcase className="w-4 h-4 text-[#525252]" /><span className="text-sm font-medium text-[#525252]">Espace Manager</span></div>
          </div>
