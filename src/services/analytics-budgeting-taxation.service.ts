...
class AnalyticalAxisService {
  async getAll(params?: ListParams) { try { const r = await apiService.get(`${BASE_PATH}/analytics/axes/`, { params }); return r.data; } catch (err) { /* silent */ return { results: [], count: 0 }; } }
  async getById(id: string) { try { const r = await apiService.get(`${BASE_PATH}/analytics/axes/${id}/`); return r.data; } catch (err) { /* silent */ return null; } }
...
class AnalyticalCentersService {
  async getAll(params?: ListParams) { try { const r = await apiService.get(`${BASE_PATH}/analytics/centers/`, { params }); return r.data; } catch (err) { /* silent */ return { results: [], count: 0 }; } }
  async getByAxis(axisId: string) { try { const r = await apiService.get(`${BASE_PATH}/analytics/axes/${axisId}/centers/`); return r.data; } catch (err) { /* silent */ return []; } }
...
class BudgetsService {
  async getAll(params?: ListParams) { try { const r = await apiService.get(`${BASE_PATH}/budgeting/budgets/`, { params }); return r.data; } catch (err) { /* silent */ return { results: [], count: 0 }; } }
  async getById(id: string) { try { const r = await apiService.get(`${BASE_PATH}/budgeting/budgets/${id}/`); return r.data; } catch (err) { /* silent */ return null; } }
...
class BudgetControlService {
  async getAll(params?: ListParams) { try { const r = await apiService.get(`${BASE_PATH}/budgeting/controls/`, { params }); return r.data; } catch (err) { /* silent */ return { results: [], count: 0 }; } }
  async getByBudget(budgetId: string) { try { const r = await apiService.get(`${BASE_PATH}/budgeting/budgets/${budgetId}/control/`); return r.data; } catch (err) { /* silent */ return null; } }
  async getSummary(params?: ListParams) { try { const r = await apiService.get(`${BASE_PATH}/budgeting/controls/summary/`, { params }); return r.data; } catch (err) { /* silent */ return { total_budget: 0, total_actual: 0, variance: 0 }; } }
}

class TaxDeclarationsService {
  async getAll(params?: ListParams) { try { const r = await apiService.get(`${BASE_PATH}/taxation/declarations/`, { params }); return r.data; } catch (err) { /* silent */ return { results: [], count: 0 }; } }
  async getById(id: string) { try { const r = await apiService.get(`${BASE_PATH}/taxation/declarations/${id}/`); return r.data; } catch (err) { /* silent */ return null; } }
  ...
  async getPending() { try { const r = await apiService.get(`${BASE_PATH}/taxation/declarations/pending/`); return r.data; } catch (err) { /* silent */ return []; } }
}
