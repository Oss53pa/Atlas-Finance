...
class FixedAssetsService {
  async getAll(params?: AssetsQueryParams) { try { const r = await apiService.get(`${BASE_PATH}/fixed-assets/`, { params }); return r.data; } catch (err) { /* silent */ return { results: [], count: 0 }; } }
...
class DepreciationsService {
  async getAll(params?: DepreciationQueryParams) { try { const r = await apiService.get(`${BASE_PATH}/depreciations/`, { params }); return r.data; } catch (err) { /* silent */ return { results: [], count: 0 }; } }
...
class AssetsReportsService {
  async getAssetRegister(params?: AssetsReportParams) { try { const r = await apiService.get(`${BASE_PATH}/reports/register/`, { params }); return r.data; } catch (err) { /* silent */ return { assets: [] }; } }
  async getDepreciationSchedule(params?: AssetsReportParams) { try { const r = await apiService.get(`${BASE_PATH}/reports/depreciation-schedule/`, { params }); return r.data; } catch (err) { /* silent */ return { schedule: [] }; } }
  async getAssetSummary(params?: AssetsReportParams) { try { const r = await apiService.get(`${BASE_PATH}/reports/summary/`, { params }); return r.data; } catch (err) { /* silent */ return { total_value: 0, total_depreciation: 0, net_value: 0 }; } }
}
