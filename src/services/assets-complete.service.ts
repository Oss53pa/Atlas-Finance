...
class FixedAssetsService {
  async getAll(params?: AssetsQueryParams) { try { const r = await apiService.get(`${BASE_PATH}/fixed-assets/`, { params: params as Record<string, unknown> }); return r.data; } catch (err) { /* silent */ return { results: [], count: 0 }; } }
  async getById(id: string) { try { const r = await apiService.get(`${BASE_PATH}/fixed-assets/${id}/`); return r.data; } catch (err) { /* silent */ return null; } }
  ...
  async getCategories() { try { const r = await apiService.get(`${BASE_PATH}/categories/`); return r.data; } catch (err) { /* silent */ return []; } }
}
...
class DepreciationsService {
  async getAll(params?: DepreciationQueryParams) { try { const r = await apiService.get(`${BASE_PATH}/depreciations/`, { params: params as Record<string, unknown> }); return r.data; } catch (err) { /* silent */ return { results: [], count: 0 }; } }
  async getByAsset(assetId: string) { try { const r = await apiService.get(`${BASE_PATH}/fixed-assets/${assetId}/depreciations/`); return r.data; } catch (err) { /* silent */ return []; } }
...
class AssetsReportsService {
  async getAssetRegister(params?: AssetsReportParams) { try { const r = await apiService.get(`${BASE_PATH}/reports/register/`, { params: params as Record<string, unknown> }); return r.data; } catch (err) { /* silent */ return { assets: [] }; } }
  async getDepreciationSchedule(params?: AssetsReportParams) { try { const r = await apiService.get(`${BASE_PATH}/reports/depreciation-schedule/`, { params: params as Record<string, unknown> }); return r.data; } catch (err) { /* silent */ return { schedule: [] }; } }
  async getAssetSummary(params?: AssetsReportParams) { try { const r = await apiService.get(`${BASE_PATH}/reports/summary/`, { params: params as Record<string, unknown> }); return r.data; } catch (err) { /* silent */ return { total_value: 0, total_depreciation: 0, net_value: 0 }; } }
}
