  ...
  return {
    ...
    tableaux: [{
      ...
      lignes: [
        ...
        { Nature: 'Production immobilisée / stockée (71)', 'Montant N': sumByAccountPrefix(entries, '71', 'credit'), 'Montant N-1': sumByAccountPrefix(previousEntries, '71', 'credit') },
        { Nature: 'Autres produits (75)', 'Montant N': sumByAccountPrefix(entries, '75', 'credit'), 'Montant N-1': sumByAccountPrefix(previousEntries, '75', 'credit') },
      ],
    }],
    calculsAuto: true,
    statut: 'generee',
