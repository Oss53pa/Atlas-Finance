    ...
    sheets: [
      {
        ...
        columns: [
          ...
          { key: 'numeroEcriture', header: 'N° écriture', aliases: ['NumeroEcriture', 'EcritureNum', 'Numero', 'NumeroSaisie', 'N_Saisie', 'NumeroDeSaisie', 'PieceNum', 'NumPiece'], required: true, type: 'string', example: 'VE-2026-0001' },
          { key: 'compte', header: 'Compte', aliases: ['CompteNum', 'Numero_Compte', 'NoCompte'], required: true, type: 'string', example: '411000' },
          { key: 'libelleCompte', header: 'Libellé compte', aliases: ['LibelleCompte', 'CompteLib', 'Libelle', 'Intitule', 'IntituleCompte', 'NomCompte'], required: false, type: 'string', example: 'Clients' },
          { key: 'tiers', header: 'Tiers', aliases: ['CodeTiers', 'CompAuxNum', 'Auxiliaire', 'CompteAux'], required: false, type: 'string', example: 'CLI001' },
          { key: 'libelleEcriture', header: 'Libellé écriture', aliases: ['LibelleEcriture', 'EcritureLib', 'Description', 'LibelleEcriture', 'Commentaire', 'Memo'], required: false, type: 'string', example: 'Facture SANGA' },
          { key: 'piece', header: 'Pièce', aliases: ['PieceRef', 'ReferencePiece', 'PieceReference'], required: false, type: 'string', example: 'FAC-2026-001' },
          { key: 'debit', header: 'Débit', aliases: ['Debit', 'MontantDebit', 'MtDebit'], required: true, type: 'number', example: 118000 },
          { key: 'credit', header: 'Crédit', aliases: ['Credit', 'MontantCredit', 'MtCredit'], required: true, type: 'number', example: 0 },
          { key: 'soldeProgressif', header: 'Solde progressif', aliases: ['SoldeProgressif', 'RunningBalance', 'SoldeCumule'], required: false, type: 'number', example: 118000 },
          { key: 'solde', header: 'Solde', aliases: ['Solde', 'Balance'], required: false, type: 'number', example: 0 },
          { key: 'lettrage', header: 'Lettrage', aliases: ['Lettrage', 'EcritureLet', 'CodeLettrage'], required: false, type: 'string' },
          { key: 'echeance', header: 'Échéance', aliases: ['Echeance', 'DueDate', 'DateEcheance'], required: false, type: 'date' },
        ],
      },
    ],
    sampleRows: [
