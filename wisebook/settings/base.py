"""
Base settings for WiseBook project.
"""
import os
...
MIDDLEWARE = [
    ...
    # 'django_otp.middleware.OTPMiddleware',  # Phase 2 - django-otp not in minimal requirements
    'django.contrib.messages.middleware.MessageMiddleware',
    'django.middleware.clickjacking.XFrameOptionsMiddleware',
    # 'apps.security.middleware.SecurityMiddleware',  # Phase 2 - security app disabled
...
DATABASES = {
    'default': {
        ...
        'NAME': env('DB_NAME', default='wisebook'),
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'WiseBook API',
    'DESCRIPTION': 'API Documentation for WiseBook ERP System',
    'VERSION': '3.0.0',
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': BASE_DIR / 'logs' / 'wisebook.log',
            'formatter': 'verbose',
        },
        'console': {
            'level': 'INFO',
...
# OTP Settings
OTP_TOTP_ISSUER = 'WiseBook'
OTP_LOGIN_URL = '/auth/login/'

# WiseBook Specific Settings
WISEBOOK_SETTINGS = {
...
DEFAULT_FROM_EMAIL = env('DEFAULT_FROM_EMAIL', default='noreply@wisebook.com')